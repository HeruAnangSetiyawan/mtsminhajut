...
<html lang="zxx">
  ...
  <body>
    <!--headder-->
    <div class="header-outs inner_page-banner " id="home" style="background: url(images/hero.jpg) no-repeat center;background-size: cover;">
      <div class="headder-top">
        <!--//navigation section -->
        <!-- nav -->
        <nav >
          <div id="logo">
            <h1><a href="index.php">MTS Minhajut Thoibin</a></h1>
          </div>
